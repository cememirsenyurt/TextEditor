...
public:
    ...
    void moveCursorColumnRight();

    void moveCursorColumnLeft();
    ...
    void moveCursorBackSpace();

    void editLine(char x);
    
    void cursorNewLine();

    void deleteLine();

    void reverseEditLine();

    //Okay we have line count and etc etc, now if you move the cursor right,
    // then add +1 to line and etc etc add member functions and member variables.
public:
    static unsigned int enterLn;
private:
